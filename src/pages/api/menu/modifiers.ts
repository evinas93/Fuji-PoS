...
async function handleGetModifiers(req: NextApiRequest, res: NextApiResponse, menuService: MenuService) {
  try {
...
async function handleCreateModifier(req: NextApiRequest, res: NextApiResponse, menuService: MenuService) {
  try {
